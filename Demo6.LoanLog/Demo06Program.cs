            ...
            try
            {
                ...
                try
                {
                    ...
                    if (loan != null)
                    {
                        ...
                        //Notify user the loan is locked
                        Console.WriteLine("Loan is locked.");

                        //Add a TrackedDocument to the Loan's Log
                        TrackedDocument doc = loan.Log.TrackedDocuments.Add("Bank Statement",
                            session.Loans.Milestones.Processing.Name);
                        doc.OrderDate = DateTime.Today;
                        doc.DueDays = 5;
